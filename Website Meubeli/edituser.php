      ...
      <div class="card text-center col-md-4 offset-lg-4 col-lg-4">
        ...
        <div class="card-body">
          ...
          <form action="prosesedit.php" method="post">
            ...
            NAMA
            <input type="name" class="form-control" id="nama" name="nama" placeholder="<?php echo($nama) ?>" >
            </div>
            <div class="form-group">
            EMAIL
            ...
            <div class="form-group">
            USERNAME
            <input type="text" class="form-control" id="uname" name="uname" placeholder="<?php echo($un) ?>" readonly>
            </div>
            <div class="form-group">
            PASSWORD
            ...
            <div class="form-group">
            HAK
            <input type="text" class="form-control" id="hak" name="hak" placeholder="<?php echo($hak) ?>">
            </div>
            <button type="submit" name="signup" class="btn btn-primary">Edit</button>
          </form>
        </div>
